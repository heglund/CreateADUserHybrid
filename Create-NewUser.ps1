...
# Variables #
#############
$domain = "brandagency.com.au"
$company = "The Brand Agency"
$exchangeOnlineTenantId = "TheBrandAgency" #this should be the part before .mail.onmicrosoft.com, and may be used to set the proxyAddress of the user
...
New-ADUser -Name $displayName `
    ...
    -Server $preferredDomainController `
    ...
    -Enabled $true `
    -Path $userOU `
    -OtherAttributes @{'ipPhone'="$IPPhone"; 'targetAddress'="$targetAddress"}

Write-Host "Waiting 30 seconds to ensure the user account is created before continuing."
Start-Sleep -Seconds 30
...
#
Write-Host "Connecting to Office 365 to license user - enter an Office 365 administrator's credentials."
$UserCredential = Get-Credential
